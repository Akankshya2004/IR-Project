...
# ==============================================================================
# Movie IR System - Quick Start Script
# ==============================================================================
# This script automates the setup and data processing for the movie search engine.
# It handles dependency installation, data downloading, processing, and merging.
# It now includes virtual environment management for safer package installation.
# ==============================================================================
